                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Image.asset("assets/icon/kaaba.png",height: 5,),
                                                        ...
                                                        height: Get.width>500?14.h:10.h,
                                                        width: Get.width>500?10.w:12.w,
                                                        color: Colors.amber,
                                                      ),),
                                              ...
                                              Positioned(
                                                  ...
                                                  left:Get.width>500?(size.width/2)-size.width*0.15:(size.width/2)-size.width*0.19,
                                                  child: Image.asset("assets/icon/kaaba.png",height: 6.h,width: 6.h,))
                                            ],
                                          ),
                                        ),
                          ...
                          controller.locationAddress!=null&& snapshot.data?.heading!=null?Positioned(
                              top: Get.height-35.h,
                              right: 0,
                              child: Container(
                          ...
                          snapshot.data?.heading==null?Positioned(
                              top: Get.height-35.h,
                              right: 0,
                              child: Container(
                                padding: EdgeInsets.only(left: 20,right: 20),
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          SizedBox(width: 5,),
                                          Text("Device does not have compass sensor",style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Colors.white),),
                                        ],
                                      ),
                                    ),
                                  ],
