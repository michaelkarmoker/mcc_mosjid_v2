...
import 'package:mccs_masjid/view/base/ProgressHUD.dart';
import 'package:mccs_masjid/view/screen/prayer_time_screen/widget/prayer_time_widget.dart';
import 'package:flutter/material.dart';
import 'package:mccs_masjid/view/screen/prayer_time_update_screen/widget/prayer_time_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:  AppBar(
        ...
        centerTitle: false,
        title: Container(child: Text("Salah Timings Update",style: appBarTextStyle.copyWith(fontSize: Dimensions.fontSizeExtraLarge,color: Colors.white),)),
