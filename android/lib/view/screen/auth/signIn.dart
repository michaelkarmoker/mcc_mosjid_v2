...
class SignIn extends StatefulWidget {
  ...
  const SignIn({Key? key, required this.exitFromApp, required this.fromPage}) : super(key: key);
  @override
...
class _signInState extends State<SignIn> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
        appBar: widget.fromPage=="home"?CustomAppBar(title: 'Member Login', isBackButtonExist: true,):null,
