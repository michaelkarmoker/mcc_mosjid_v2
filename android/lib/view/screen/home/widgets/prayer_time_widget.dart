...
class PrayerTimeSliderWidget extends StatelessWidget {
          ...
          children: [
            controller.prayerTimeList.length>0?Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("Salah Timings",style: robotoMedium.copyWith(fontSize: 12.sp),),
                      InkWell(
                          onTap: (){
                ...
                SizedBox(height: 15,),
                Container(
                  height: Get.width>500?27.h:22.5.h,
  ...
  Widget button({required bool isRight}){
    return Container(
      ...
      child: Icon(isRight?Icons.arrow_forward_ios_outlined:Icons.arrow_back_ios_new,color:Colors.grey[100],size: 2.h,),
    );
  }
        ...
        width: Get.width/3.4,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 2.h,),
                Image.asset(icon,height: 6.h,),
                SizedBox(height: 0.5.h,),
                Text("${title}",style: robotoMedium.copyWith(fontSize: 11.sp,color:Colors.black87),),
                SizedBox(height: 0.5.h,),
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                        flex: 1,
                        child: Image.asset("assets/icon/azan_time.png",height: 5.w,)),

                    Expanded(
                      flex: 2,
                      child: Text("${adhanTime.toUpperCase()}",
                        textAlign: TextAlign.left,
                        style: robotoMedium.copyWith(fontSize: 9.sp,color: Colors.green),),
                    ),
                  ],
                ),
                SizedBox(height: 4,),
                Row(
                  ...
                  children: [
                    Expanded(
                        flex:1,child: Image.asset("assets/image/clock.png",height: 5.w)),
                    Expanded(
                      flex: 2,
