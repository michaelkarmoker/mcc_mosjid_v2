...
class CustomTextFromFieldWithTitle extends StatefulWidget {
  final String title;
...
class _CustomTextFieldState extends State<CustomTextFromFieldWithTitle> {
